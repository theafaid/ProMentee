                ...
                @auth
                    <div class="dropdown d-none d-md-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar mr-3 align-self-center" style="background-image: url({{asset('design')}}/demo/faces/female/1.jpg)"></span>
                                <div>
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar mr-3 align-self-center" style="background-image: url({{asset('design')}}/demo/faces/female/18.jpg)"></span>
                                <div>
                    ...
                    <div class="dropdown">
                        <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                            <span class="avatar" style="background-image: url({{asset('design')}}/demo/faces/female/25.jpg)"></span>
