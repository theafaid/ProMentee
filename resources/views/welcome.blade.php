                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table card-table table-striped table-vcenter">
                            ...
                            <tbody>
                            <tr>
                                <td class="w-1"><span class="avatar" style="background-image: url({{asset('design')}}/demo/faces/male/9.jpg)"></span></td>
                            ...
                            <tr>
                                <td><span class="avatar" style="background-image: url({{asset('design')}}/demo/faces/female/1.jpg)"></span></td>
                            ...
                            <tr>
                                <td><span class="avatar" style="background-image: url({{asset('design')}}/demo/faces/male/4.jpg)"></span></td>
                                <td>Bobby Knight</td>
                            ...
                            <tr>
                                <td><span class="avatar" style="background-image: url({{asset('design')}}/demo/faces/female/11.jpg)"></span></td>
                                <td>Sharon Wells</td>
                                <td>Fixes #625</td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <a href="https://gumroad.com/l/tabler-email?utm_source=demo" class="card" target="_blank">
                            <img src="{{asset('design')}}/demo/card-demo.jpg" alt="" class="card-img">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row row-cards row-deck">
            <div class="col-lg-6">
                <div class="card card-aside">
                    <a href="#" class="card-aside-column" style="background-image: url({{asset('design')}}/photos/david-klaasen-54203-500.jpg)"></a>
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center pt-5 mt-auto">
                            <div class="avatar avatar-md mr-3" style="background-image: url({{asset('design')}}/demo/faces/female/18.jpg)"></div>
                            <div>
            ...
            <div class="col-lg-6">
                <div class="card card-aside">
                    <a href="#" class="card-aside-column" style="background-image: url({{asset('design')}}/photos/david-marcu-114194-500.jpg)"></a>
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center pt-5 mt-auto">
                            <div class="avatar avatar-md mr-3" style="background-image: url({{asset('design')}}/demo/faces/male/16.jpg)"></div>
                            <div>
                        ...
                        <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/26.jpg)">
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/17.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/21.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/male/32.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/12.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/4.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/27.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="avatar d-block" style="background-image: ur{{asset('design')}}/demo/faces/male/20.jpg)">
                                        <span class="avatar-status bg-green"></span>
                                    </div>
                                </td>
                                <td>
                        ...
                        <ul class="list-unstyled list-separated">
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/12.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
                            ...
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/21.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
                            ...
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/29.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
                            ...
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/2.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
                            ...
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/male/34.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
                            ...
                            <li class="list-separated-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="avatar avatar-md d-block" style="background-image: ur{{asset('design')}}/demo/faces/female/11.jpg)"></span>
                                    </div>
                                    <div class="col">
                                        <div>
